...
export function LoadMappingModal({
  ...
  return (
    ...
    >
      ...
      {confirmDeleteTarget && (
        <ConfirmModal
          message={t('confirmDeleteTemplate', 'Möchten Sie die Vorlage „{{name}}“ wirklich löschen?', { name: confirmDeleteTarget.name })}
          confirmLabel={t('deleteTemplate', 'Vorlage löschen')}
