...
const TYPE_IDS = ['object', 'entity', 'place', 'occurrence', 'procedure', 'collection', 'storage_location']
...
export function ScreenFormVariants({ initialPath, onPathChange }: Props = {}) {
  ...
  const [confirmTarget, setConfirmTarget] = useState<FormVariant | null>(null)
  ...
  const TYPES = [
    ...
    { id: 'storage_location', label: t('types.storage_location') },
  ]
