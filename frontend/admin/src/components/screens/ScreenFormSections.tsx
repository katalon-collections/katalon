...
export function ScreenFormSections({ targetType, targetSubtype }: Props) {
  ...
  const [confirmTarget, setConfirmTarget] = useState<FormSection | null>(null)
  ...
  function del(section: FormSection) {
    setConfirmTarget(section)
  }

  async function confirmDelete() {
    const section = confirmTarget!
