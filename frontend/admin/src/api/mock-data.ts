...
export const MOCK_OBJECTS: KatalonObject[] = [
  { id: 'OBJ-2026-00412', idno: 'FOT.1958.0412', status: 'public',   metadata_: { title: 'Bahnhofstraße bei Nacht', creator: 'Henri Cartier', year: '1958', medium: 'Silbergelatine' }, created_at: '2026-01-10T08:00:00Z', updated_at: '2026-04-30T08:42:00Z' },
  { id: 'OBJ-2026-00411', idno: 'FOT.1972.0118', status: 'internal', metadata_: { title: 'Selbstporträt mit Schatten', creator: 'Lina Maier', year: '1972', medium: 'Chromogen-Druck' }, created_at: '2026-01-10T08:00:00Z', updated_at: '2026-04-30T06:31:00Z' },
  { id: 'OBJ-2026-00410', idno: 'FOT.1942.0049', status: 'draft',    metadata_: { title: 'Werft an der Limmat', creator: 'Unbekannt', year: 'ca. 1942', medium: 'Negativ, Glas' }, created_at: '2026-04-29T09:18:00Z', updated_at: '2026-04-29T09:18:00Z' },
  { id: 'OBJ-2026-00409', idno: 'FOT.1965.0233', status: 'public',   metadata_: { title: 'Markttag in der Altstadt', creator: 'G. Albrecht', year: '1965', medium: 'Silbergelatine' }, created_at: '2026-01-10T08:00:00Z', updated_at: '2026-04-29T16:51:00Z' },
  { id: 'OBJ-2026-00408', idno: 'FOT.1962.0114', status: 'public',   metadata_: { title: 'Kinder am See', creator: 'G. Albrecht', year: '1962', medium: 'Silbergelatine' }, created_at: '2026-01-10T08:00:00Z', updated_at: '2026-04-28T14:00:00Z' },
  { id: 'OBJ-2026-00407', idno: 'FOT.1948.0007', status: 'internal', metadata_: { title: 'Werkstatt Brunner', creator: 'Hans Brunner', year: '1948', medium: 'Negativ, Glas' }, created_at: '2026-01-10T08:00:00Z', updated_at: '2026-04-28T11:00:00Z' },
  { id: 'OBJ-2026-00406', idno: 'FOT.1960.0721', status: 'public',   metadata_: { title: 'Tramhaltestelle Paradeplatz', creator: 'Henri Cartier', year: '1960', medium: 'Silbergelatine' }, created_at: '2026-01-10T08:00:00Z', updated_at: '2026-04-27T10:00:00Z' },
  { id: 'OBJ-2026-00405', idno: 'FOT.1975.0044', status: 'draft',    metadata_: { title: 'Studio-Stillleben mit Geige', creator: 'Lina Maier', year: '1975', medium: 'Chromogen-Druck' }, created_at: '2026-01-10T08:00:00Z', updated_at: '2026-04-27T09:00:00Z' },
]
