    ...
    <>
      ...
      <main id="main-content" style={{ flex: 1, width: '100%' }}>
        <Routes>
          ...
          <Route path="/objects/:id" element={<ErrorBoundary><Suspense fallback={null}><ObjectDetailPage user={user} /></Suspense></ErrorBoundary>} />
          <Route path="/entities/:id" element={<EntityDetailPage user={user} />} />
          <Route path="/places/:id" element={<PlaceDetailPage user={user} />} />
          <Route path="/occurrences/:id" element={<OccurrenceDetailPage user={user} />} />
