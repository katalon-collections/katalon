...
### Fixed
- ARK-Resolver und Kollisionsprüfung verwenden korrekte JSONB-Parameterbindung, damit ARKs in `metadata` zuverlässig gesucht werden.
...
- Verknüpfte Objekte mit mehreren Relationstypen erscheinen im Portal nicht mehr als doppelte Karten; Relation-Typ-Chips zeigen die Trefferzahl.
...
### Changed
- Felddefinitionen sind übersichtlicher: Grundoptionen und feldtypspezifische Einstellungen bleiben sichtbar, weitere Steuerungsoptionen liegen unter „Erweiterte Optionen“.
...
### Fixed
- Portal-Suchfacetten bleiben nach Reloads stabil, auch wenn ein älterer paralleler Suchlauf erst nach der konfigurierten Facettenabfrage antwortet.
