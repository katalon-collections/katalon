...
summary: "Katalon's importer pipeline moves CSV, Excel, and XML files through upload, mapping, dry-run validation, optional vocabulary reconciliation, and Celery-backed record creation."
topics: [architecture, workflows, importer, celery, metadata, vocabularies]
sources:
  - id: importer-api
    type: file
