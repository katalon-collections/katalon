...
from katalon.core.dependencies import CurrentUser, DBDep, has_record_permission, require_feature
...
router = APIRouter(prefix="/batch", tags=["batch"], dependencies=[require_feature("batch")])
