"""add password reset tokens and JWT token version
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_password_reset_tokens_request_hash"), "password_reset_tokens", ["request_hash"])
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_password_reset_tokens_request_hash"), table_name="password_reset_tokens")
